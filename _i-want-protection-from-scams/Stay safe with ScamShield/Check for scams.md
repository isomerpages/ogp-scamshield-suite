...
<p>The enhanced ScamShield app uses an AI-powered classifier to help you
identify potential scams. By submitting a number, message or link, ScamShield
can:</p>
...
you can ensure any transactions you're making are legitimate. Make it a
habit to check suspicious things on the ScamShield app!</p>
<p></p>
<h4><strong>How it works</strong></h4>
<div class="isomer-image-wrapper">
<img style="width: 30%;" height="auto" width="100%" alt="" src="/images/step_1.png">
</div>
...
<p></p>
<div class="isomer-image-wrapper">
<img style="width: 30%;" height="auto" width="100%" alt="" src="/images/step_2.png">
</div>
<ol start="2" data-tight="true" class="tight">
<li>
<p>Enter the suspicious number, message, or link you want to check. For message
checks, you can upload message screenshots from SMS, WhatsApp, and Telegram.</p>
</li>
</ol>
<p></p>
<div class="isomer-image-wrapper">
<img style="width: 30%;" height="auto" width="100%" alt="" src="/images/step_3.png">
</div>

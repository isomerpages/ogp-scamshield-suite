...
### Immediate Actions  
1. Keep calm.
2. Immediately call your bank to freeze your bank account (hotline numbers listed below).
3. You can also activate the Kill Switch on your banking app if it has one. 
* The Kill Switch is&nbsp;a self-service security feature that enables you to immediately freeze all your current and savings accounts (including joint accounts).
